...
vim.keymap.set("n", "<leader>do", ":lua require('dap').step_over()<CR>", { noremap = true })
...
vim.keymap.set("n", "<leader>dl", ":lua require('dap').run_last()<CR>", { noremap = true })
vim.keymap.set("n", "<leader>de", ":lua require('dap').terminate()<CR>", { noremap = true })

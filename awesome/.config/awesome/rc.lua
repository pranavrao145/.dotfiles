...
globalkeys = gears.table.join(
  ...
  -- Change screen resolution for monitor
  awful.key({ modkey, "Shift", "Control" }, "n", function()
    ...
    description = "adjust resolution for monitor",
    group = "launcher",
  }),
  -- Change screen resolution for laptop
  awful.key({ modkey, "Shift", "Control" }, "m", function()
    ...
    description = "adjust resolution for laptop",
    group = "launcher",
  })
)
...
autorunApps = {
  "picom --experimental-backgrounds",
  "nitrogen --restore",
  "xrandr --output eDP1 --mode 1280x720 --pos 1920x0 --rotate normal --output HDMI1 --primary --mode 1920x1080 --pos 0x0 --rotate normal --output VIRTUAL1 --off",
}
if autorun then
